...
namespace OVERLAY {
  ...
  public:
    ...
    /*!
     * \brief Whether the overlay is authored as HDR PQ code values
     * (e.g. UHD-BD PGS subtitles). Such overlays must bypass the
     * SDR→PQ conversion and be rendered directly in the PQ domain.
     */
    virtual bool IsHdrPqAuthored() const { return false; }
